<template>
	<view class="all">
		<view class="message">
			...
			<view class="grid-3" @click="goDetail">
				<view class="grid-3-item">
...
<script>
	export default {
			...
			methods: {
				getDetail() {
					uni.request({
						url: 'http://xiaojie.xuejss.com/xw/appxjxjliu.php?id=' + this.banner.id,
						success: (data) => {
					...
					uni.request({
						url: 'http://xiaojie.xuejss.com/xw/appxjxjliucount.php?id=' + this.banner.id,
						success: (data) => {
							if (data.statusCode == 200) {				
				...
				uni.request({
					url: 'http://xiaojie.xuejss.com/xw/appxjxjphoto.php?id=' + this.banner.id,
					success: (data) => {
						if (data.statusCode == 200) {	
				...
				goDetail() {
					uni.navigateTo({
						url: "../pfxf/xqing/detail1?xxid=2&id=" + this.banner.id
					})
				},
	                ...
	                var url = 'http://xiaojie.xuejss.com/xw/share_xjxj.php?id='+ this.banner.id;
	                 console.log(url);
	uni.share({
	    provider: "weixin",
