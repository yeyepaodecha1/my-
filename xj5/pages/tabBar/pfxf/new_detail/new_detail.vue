<template>
	<view>
		<view class="banner">
			<image class="banner-img" :src="banner.cover" @error="handleError"></image>
			<view class="banner-title">{{banner.title}}</view>
		</view>
		<view class="article-meta">
			<text class="article-author">{{banner.moduleName}}</text>
			<text class="article-text">发表于</text>
			<text class="article-time">{{banner.createTime}}</text>
		</view>
