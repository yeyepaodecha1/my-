		 ...
		 indicator-active-color="white">
			<swiper-item>
				<view class="swiper-item">
					<image src="http://xiaojie.xuejss.com/img/img/njlg/1.jpeg" mode=""></image>
				</view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-item">
					<image src="http://xiaojie.xuejss.com/img/img/njlg/2.jpg" mode=""></image>
				</view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-item">
					<image src="http://xiaojie.xuejss.com/img/img/njlg/3.png" mode=""></image>
				</view>
			</swiper-item>
			<swiper-item>
				<view class="swiper-item">
					<image src="http://xiaojie.xuejss.com/img/img/njlg/4.jpg" mode=""></image>
				</view>
			</swiper-item>
		</swiper>
		<view class="main">
			...
			<view class="text">
				<h2>南京理工简介</h2>
				<h4>Nanjing University of Science & Technology</h4>
				<p>
				...
				<p>
					新时代展现新气象，新使命呼唤新作为。学校将大力弘扬优良传统，紧紧抓住“双一流”建设机遇，以博大的胸襟，宽广的视野，务实的作风，求是的精神，开拓进取，接续奋斗，坚定不移地朝着国内一流、国际知名的高水平研究型大学战略目标阔步前进，为实现“两个一百年”奋斗目标、实现中华民族伟大复兴的中国梦做出更大贡献。院是江苏省构建现代职教体系试点单位，先后与南京艺术学院、常州大学、南京审计大学合作开展专科与本科“3+2”分段培养项目，与南京师范大学、苏州大学、南京艺术学院等多所本科院校进行专本对接合作。近年来学院以文化交流、学术研讨、校际合作等为重点，不断推进国际化教育交流和合作进程，定期选派师生赴境外短期研习，资助优秀学生赴新加坡、台湾等地参加游学项目。毕业生就业前景广阔，就业率连续多年保持在98％以上，就业竞争力指数位居全省高职高专院校前列。
				</p>
